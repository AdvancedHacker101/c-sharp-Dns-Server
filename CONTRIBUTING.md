# Contribution
**Thank you for considering contribution to the C\# DNS Server Project!**  
## How to contribute?
It's very simple!  
1. Fork the project  
2. Make the changes  
...
This project is written in c\# and built with .NET Framework 4.5.2  
Any additional dependencies can be found at dnsServer/bin/Debug
